...
public abstract class AbstractUserFileRepository<ID, E extends Entity<ID>> extends UserMemoryRepository<ID, E> {
    private String fileName;

    public AbstractUserFileRepository(String fileName, Validator<E> validator) {
        super(validator);
     ...
     * */
    protected void writeToFileAll(Iterable<E> users){
    ...
    public E delete(ID id){
        ...
        E e = super.delete(id);
        if(e != null){
            Iterable<E> users = super.getAllEntities();
